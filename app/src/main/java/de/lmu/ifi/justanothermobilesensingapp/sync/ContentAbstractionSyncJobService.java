package de.lmu.ifi.justanothermobilesensingapp.sync;
...
/**
 * A sample class demonstrating how the sync to our backend could be implemented
 * mind to register it in the Manifest
 */
